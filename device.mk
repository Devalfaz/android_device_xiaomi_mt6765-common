...
# Perf
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/perf/fstb.cfg:$(TARGET_COPY_OUT_VENDOR)/etc/fstb.cfg \
    $(LOCAL_PATH)/configs/perf/fteh.cfg:$(TARGET_COPY_OUT_VENDOR)/etc/fteh.cfg \
    $(LOCAL_PATH)/configs/perf/power_whitelist_cfg.xml:$(TARGET_COPY_OUT_VENDOR)/etc/power_whitelist_cfg.xml \
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/thermal/thermal_high.conf:$(TARGET_COPY_OUT_VENDOR)/etc/.tp/thermal_high.conf \
